...
Based on [pix2pix](https://phillipi.github.io/pix2pix/) by Isola et al. and [pix2pix-tensorflow] (https://github.com/affinelayer/pix2pix-tensorflow) 
...
python pix2pix.py \
  ...
  --max_epochs 200 \
  --input_dir ./dataset/CUHKfaces/face2edge/train \
  --lab_colorization \
  --which_direction BtoA
```

# test the model with the CUHK training model + CUHK test dataset
python pix2pix.py \
  --mode test \
  --output_dir ./dataset/CUHKfaces_test \
  --input_dir ./dataset/CUHKfaces/face2edge/test \
